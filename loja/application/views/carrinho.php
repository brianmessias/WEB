<?php 
	...
	foreach($this->cart->contents() as $item){
		...
		"<div class='span1'>".anchor(base_url('carrinho/remover/'.$item['rowid']), "Remover") . "</div>" .
	...
	echo br(). "<div class='row-fluid'>" .
		"<div class='span3'>" . form_submit('btnAtualizar', 'Atualiazar quantidades') . "</div>" .
		"<div class='span6'>" . anchor(base_url('carrinho/pagar'), "Pagar e finalizar compra") . "</div>" .
		"<div class='span1' texto-direita'>Total:</div>".
		"<div class='span1' texto-direita'>" . reais($this->cart->total()) . "</div>" . "</div>" .
		form_close(); 
	if($frete){
		echo "<div class='row-fuid'>" .
		"<div class='span9'></div>" .
		"<div class='span1 texto-direita'>Frete:</div>" .
		"<div class='span2'texto-direita'>" . reais($frete) ."</div" .
		"</div><div class='row-fuid'>" .
		...
		" para calcular o frente e finalizar a compra " .
		"</div>" . "</div>";	
	}